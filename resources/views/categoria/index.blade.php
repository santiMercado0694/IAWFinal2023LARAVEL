                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Si borra un producto que tiene la categoria "{{$categoria->nombre}}", se eliminaran todos los productos con dicha categoria, para evitar esto recuerde cambiar la categoria del producto a "Sin categoria".
